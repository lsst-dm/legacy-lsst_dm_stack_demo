...
processCcdSdss.py input --id run=4192 filter=$FILTER_SET_4192 camcol=4 field=300 --id run=6377 filter=$FILTER_SET_6377 camcol=4 field=399 --config calibrate.detectAndMeasure.doDeblend=False --output output$SIZE_EXT
